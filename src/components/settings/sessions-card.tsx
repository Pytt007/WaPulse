  ...
  return (
    <>
      <Card className="bg-slate-900/40 border-slate-800">
        <CardHeader>
          ...
          <CardDescription className="text-slate-400">
            {t("Sign out of every device where you're logged in — including this one. Useful if you lost a laptop or shared your password.")}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("Sign out everywhere?")}</DialogTitle>
            <DialogDescription>
              {t("Every device logged into this account will be signed out and will need to log in again. You will be redirected to the login page.")}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
